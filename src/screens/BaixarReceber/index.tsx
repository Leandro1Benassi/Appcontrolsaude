...
const BaixarPagar: React.FC = () => {
    ...
    let valor_multa:any = route?.params?.multa;
    let valor_juros:any = route?.params?.juros;
        
    let [valor, setValor] = useState(valor_conta);
    const [saida, setSaida] = useState("Caixa");
    let [multa, setMulta] = useState(valor_multa.toFixed(2));
    let [juros, setJuros] = useState(valor_juros.toFixed(2));
    ...
    async function calcular() {
        ...
        try {
            ...
            const res = await api.post("receber/calcular.php", obj);
            setSubtotal(res.data.mensagem.toFixed(2));  
    ...
    async function saveData() {
        ...
        try {
            ...
            setMulta(valor_multa);
            setJuros(valor_juros);
            setDesconto("");
